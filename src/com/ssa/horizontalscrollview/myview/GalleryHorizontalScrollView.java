...
public class GalleryHorizontalScrollView extends HorizontalScrollView implements OnClickListener {
    ...
    public void setmOnCurrentImageChangeListener(OnCurrentImageChangeListener mListener) {
    ...
    public void initData(GalleryHorizontalScrollViewAdapter mAdapter) {
        ...
        if (mChildHeight == 0 && mChildWidth == 0) {
            ...
            if (mAdapter.getCount() < mCountOneScreen) {
                initFirstScreenChildren(mdisplayLastIndex);
            } else {
    ...
    private void notifyCurrentImgChanged() {
        ...
        mOnCurrentImageChangeListener.onCurrentImgChanged(mAllFirstIndex, mContainer.getChildAt(0));
    }
